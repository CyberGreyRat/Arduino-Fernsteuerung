/*
 * FINALER FLUG-SENDER (Arduino Nano)
 * ----------------------------------
 * Basis: Dein "Perfekter Testcode" (V2)
 * Anpassung: PA Level auf MAX für 300m+ Reichweite
 * Feature: Serial Output bleibt aktiv (für Telemetrie am Boden vor Start)
 * * Hardware:
 * nRF24:     D9, D10
 * MPU6050:   A4, A5
 * Rotary:    D2, D3
...
void loop() {
  ...
  if (gyroMode) {
    ...
    data.pitch = map(accY, -17000, 17000, 0, 255); 
  } else {
    // Joystick
    // INVERTIERUNGEN übernommen
